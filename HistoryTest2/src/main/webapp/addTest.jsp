...
<body>
<f:form action="addTest" method="post" modelAttribute="regTest" >
...
<br/><input type="submit" value="Add"  id="" name=""/><input type="submit" value="Cansl" onclick="this.form.action = 'canslAddTest'" />
</f:form>
</body>
</html>